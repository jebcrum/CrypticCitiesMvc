...
namespace CrypticCities.Controllers
{
    public class VotesController : Controller
    {
        ...
        {
            var votes = db.Votes.Include(v => v.CrypticCity);
        ...
        {
            ViewBag.CrypticCityId = new SelectList(db.CrypticCities, "Id", "Clue");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,CrypticCityId,IsApproved,User,IPAddress")] Vote vote)
        {
